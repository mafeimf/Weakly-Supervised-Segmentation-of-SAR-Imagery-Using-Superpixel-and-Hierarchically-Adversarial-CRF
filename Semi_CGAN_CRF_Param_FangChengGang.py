...
#             nn.Sigmoid(),
        ...
        self.matrix = nn.Parameter(torch.Tensor(self.class_num,self.class_num))
...
class Semi_DCGAN_FangChengGang(object):
    def __init__(self, args,ALL_DATA_X_L, ALL_DATA_Y_L_vec, ALL_DATA_X_no_L, ALL_DATA_Y_no_L_vec):
        ...
        ALL_pretrained_dict=torch.load(os.path.join(self.save_dir, self.model_dir, 'CGAN_CRF' + '_D_6trainImg_5class.pkl'))
